...
const namesTable = [
  ...
  i18next.t('facilities:alchemy'),
  i18next.t('facilities:atomic'),
  i18next.t('facilities:darkmatter'),
  ...
  i18next.t('facilities:technology'),
  i18next.t('facilities:city'),
  i18next.t('facilities:stabilizer'),
  i18next.t('facilities:information'),
  i18next.t('facilities:time'),
  i18next.t('facilities:relifer'),
];
