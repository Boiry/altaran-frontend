...
export const cTable2 = {
  ...
  instruction: "Institution de l'instruction",
  military: 'Base militaire',
  maintenance: 'Centre de maintenance',
  concentrator: 'Concentrateur de matière noire',
  intelligence: 'Centre de renseignement',
  development: 'Centre de développement',
  politics: 'Institut politique',
  monument: 'Monument',
  technology: "Centre d'avancement technologique avancé",
  city: 'Cité planétaire',
  stabilizer: 'Stabilisateur du noyau',
  information: "Centre d'information sensible",
  time: 'Distorsion temporrelle',
  relifer: 'Revitalisateur',
};
